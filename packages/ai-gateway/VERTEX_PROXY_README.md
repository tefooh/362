...
This proxy allows the Claude Agent SDK to use Vertex AI without requiring users to set up GCP credentials. Users just log in to Project 362, and the proxy handles authentication with Vertex AI using Project 362's service account.

## How It Works

1. User logs in to Project 362 desktop app
2. Desktop app configures Agent SDK with environment variables:
   - `CLAUDE_CODE_USE_VERTEX=1`
   - `ANTHROPIC_VERTEX_BASE_URL=https://ai-gateway.i-f9f.workers.dev` (or your worker URL)
...
**Headers:**
- `Authorization: Bearer <user-token>` - User's Project 362 auth token
