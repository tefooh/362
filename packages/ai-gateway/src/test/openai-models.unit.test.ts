...
describe('OpenAI API accounting and routing', () => {
	...
	it('does not crash when model is undefined / null / empty (project-362-AI-PROXY-1D)', () => {
	...
	// Sentry project-362-AI-PROXY-Z + -X: OpenAI 400 "Unknown parameter:
	...
	// Sentry project-362-CLI / orphan tool messages — when chat history is
	...
	// Sentry project-362-AI-PROXY-Y: "400 Unsupported value: 'temperature'
