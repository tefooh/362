...
const CURATED_MODELS: ModelEntry[] = [
  ...
  // ── Confidential inference (project_362's own Tinfoil enclave) ──
  // Runs in our project-362/privacy-filter container at
  // pii.project-362.containers.tinfoil.dev, attested end-to-end via Sigstore
  ...
  // (E2B/E4B only — the 31B doesn't support audio at all).
  {
    ...
    description: 'confidential audio + vision + chat — your project_362 data analyzed inside an attested enclave.',
