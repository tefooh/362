...
export interface Env {
	...
	// Identity Federation → project-362-prod). See buildWifConfig in providers/vertex.ts.
	...
	WIF_SA_EMAIL?: string;
	WIF_PROJECT_ID?: string; // GCP project WIF Vertex calls bill to (default project-362-prod)
	...
	// Project362's own Tinfoil-hosted enclave (privacy-filter + Gemma 4 E4B
	// audio/vision/chat) at pii.project-362.containers.tinfoil.dev.
	...
	project_362_ENCLAVE_API_KEY?: string;
	// Admin API auth
	ADMIN_SECRET: string;
