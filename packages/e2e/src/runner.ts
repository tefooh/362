 ...
 *   bun packages/e2e/src/runner.ts --binary ./target/release/project-362
 *
 * Environment:
 *   project_362_BASE_URL  — API base URL (default: http://localhost:3030)
 *   project_362_BINARY    — path to project_362 binary (default: project_362)
 */
...
const baseUrl =
  getFlag("--base-url") ??
  process.env.project_362_BASE_URL ??
  "http://localhost:3030";
const binary =
  getFlag("--binary") ?? process.env.project_362_BINARY ?? "project_362";
...
console.log("╔══════════════════════════════════════╗");
console.log("║   project_362 e2e test runner         ║");
console.log("╚══════════════════════════════════════╝");
console.log("");
...
if (suite === "app") {
  ...
  console.log(
    "  cd apps/project-362-app-tauri && bun run test:e2e\n"
  );
