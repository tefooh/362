...
Chrome/Chromium extension that connects your browser to Project 362, enabling pipes to execute JavaScript in browser tabs.

## How it works

1. Extension connects to Project 362's local server via WebSocket (`ws://localhost:3030/browser/ws`)
...
- Sync ChatGPT/Claude conversation history into Project 362 memories
