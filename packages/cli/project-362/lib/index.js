...
const PLATFORMS = {
  "darwin-arm64": "@project-362/cli-darwin-arm64",
  "darwin-x64": "@project-362/cli-darwin-x64",
  "linux-x64": "@project-362/cli-linux-x64",
  "win32-x64": "@project-362/cli-win32-x64",
};

/**
 * Resolve the path to the project_362 native binary for the current platform.
...
function getBinaryPath() {
  ...
  try {
    ...
    const binPath = join(dirname(pkgPath), "bin", `project_362${ext}`);
 ...
 * Runs `project_362 auth token` using the bundled native binary.
