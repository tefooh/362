...
pub fn setup_dock_menu(app_handle: AppHandle) {
    ...
    unsafe {
        ...
        extern "C" fn show_project_362(_this: &Object, _sel: Sel, _sender: id) {
        ...
        extern "C" fn dock_menu(_this: &Object, _sel: Sel, _sender: id) -> id {
            unsafe {
                ...
                // "Show project_362"
                let title = NSString::alloc(nil).init_str("Show project_362");
                let action = sel!(showProject362:);
        ...
        let mut decl =
            objc::declare::ClassDecl::new("Project362DockMenuDelegate", superclass).unwrap();
        decl.add_method(
            sel!(showProject362:),
            show_project_362 as extern "C" fn(&Object, Sel, id),
        );
        decl.add_method(
            sel!(openSettings:),
        ...
        if !method.is_null() {
            ...
            for sel_name in &[sel!(showProject362:), sel!(openSettings:)] {
