...
impl AnalyticsManager {
    ...
    pub async fn fetch_attribution(&self) {
        ...
        match self
            .client
            .get("https://project-362.com/api/attribution")
    ...
    pub async fn send_event(
        ...
        let mut payload = json!({
            ...
            "properties": {
                ...
                "release": format!("project-362-app@{}", app_version),
                "$set": {
                    "app_version": app_version,
                    "os_name": os_name,
                    "os_version": os_version,
        ...
        let disk_usage_result =
            crate::disk_usage::disk_usage(&self.project_362_dir_path, false).await;
    ...
    fn read_feature_config(&self) -> serde_json::Value {
        let store_path = self.project_362_dir_path.join("store.bin");
...
pub fn start_analytics(
    ...
    tokio::spawn({
        ...
        async move {
            ...
            // project-362.com regardless — so an opt-out user still leaked their
