...
use project_362_connect::remote_sync::{self, DiscoveredHost, SyncConfig, SyncResult};
use project_362_connect::sync_scheduler::SyncScheduler;
use std::path::PathBuf;
use tauri::State;

fn default_project_362_dir() -> PathBuf {
...
pub async fn remote_sync_exec_setup(
    ...
    let cmd = format!("npx -y project_362@latest agent setup {target}");
