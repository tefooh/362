...
/**
 * Bring a tiny non-Project362 window to the foreground briefly.
 *
 * Timeline streaming filters out OCR entries whose app name contains "project_362"
 * (see create_time_series_frame in project-362-engine). Captures that only see the
 * Project362 UI therefore produce no WebSocket frames and the timeline slider
