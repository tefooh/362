...
use clap::Parser;
use futures::pin_mut;
use project_362_audio::{audio_manager::AudioManagerBuilder, core::device::list_audio_devices};
...
// ! usage - cargo run --bin project-362-audio -- --audio-device "Display 1 (output)"
...
async fn main() -> Result<()> {
    ...
    let mut builder = AudioManagerBuilder::new()
        ...
        .output_path("/tmp/project-362".into());
