...
//! real project_362 recordings, amplitude normalization effects.
//!
//! Usage:
...
use project_362_audio::vad::silero::SileroVad;
use project_362_audio::vad::VadEngine;
...
async fn main() -> anyhow::Result<()> {
    ...
    let test_cases = vec![
        ...
        TestCase {
            ...
            reference: r#"bro - got some good stuff from project_362 here's the lowdown on your day, you productivity ninja: absolutely demolished that 2-hour coding sesh on the new feature. the keyboard is still smoking, bro! crushed 3 client calls like a boss. they're probably writing love letters to you as we speak, make sure to close john tomorrow 8.00 am according to our notes, let the cash flow in! spent 45 mins on slack. 90% memes, 10% actual work. perfectly balanced, as all things should bewatched a rust tutorial. way to flex those brain muscles, you nerd! overall, you're killing it! 80% of your time on high-value tasks. the other 20%? probably spent admiring your own reflection, you handsome devil. ps: seriously, quit tiktok. your fbi agent is getting bored watching you scroll endlessly. what's the plan for tomorrow? more coding? more memes? world domination? generated by your project_362 ai assistant (who's definitely not planning to take over the world... yet)"#,
        },
        TestCase {
            name: "accuracy3 (pitch, 14s)",
            path: "test_data/accuracy3.wav",
            reference: r#"again, project_362 allows you to get meeting summaries, locally, without leaking data to openai, with any apps, like whatsapp, meet, zoom, etc. and it's open source at github.com/project-362/project-362"#,
        },
        TestCase {
    ...
    // ═══════════════════════════════════════════════════════════════════════
    // PART 4: Real project_362 recordings
    // ═══════════════════════════════════════════════════════════════════════
    println!("\n═══ PART 4: Real project_362 recordings ═══\n");
