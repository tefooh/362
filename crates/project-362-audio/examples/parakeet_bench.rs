...
//! Usage:
//!   # CPU-only
//!   cargo run --release -p project-362-audio --example parakeet_bench --features parakeet
//!
//!   # DirectML (GPU)
//!   cargo run --release -p project-362-audio --example parakeet_bench --features parakeet,directml
