...
use project_362_audio::core::device::default_input_device;
...
use project_362_audio::transcription::stt::SAMPLE_RATE;
use project_362_audio::vad::{silero::SileroVad, VadEngine};
use project_362_audio::{resample, AudioInput, TranscriptionEngine};
...
async fn test_transcription_accuracy() {
    ...
    for (audio_file, expected_transcription) in test_cases {
        ...
        let task = tokio::spawn(async move {
            ...
            let audio_data =
                project_362_audio::pcm_decode(&audio_path).expect("Failed to decode audio file");
