...
mod tests {
    ...
    use project_362_audio::core::record_and_transcribe;
    ...
    use project_362_audio::{pcm_decode, AudioInput, TranscriptionEngine};
    ...
    async fn test_record_and_transcribe() {
        ...
        let result = record_and_transcribe(
            ...
            Arc::new(sender),
            is_running,
            Arc::new(project_362_audio::metrics::AudioPipelineMetrics::new()),
        )
        .await;
    ...
    async fn test_audio_transcription_language() {
        ...
        let audio_data = project_362_audio::pcm_decode("test_data/Arifi.wav")
    ...
    async fn test_audio_stream_stop_no_race_condition() {
        ...
        // See: https://github.com/project-362/project-362/issues/3261
        setup();
