...
//! ```bash
//! # Run all benchmarks
//! cargo test --package project-362-audio --test dedup_benchmark -- --nocapture
//!
//! # Run specific scenario
//! cargo test --package project-362-audio --test dedup_benchmark continuous_24h -- --nocapture
//!
//! # Run with release optimizations (for timing accuracy)
//! cargo test --release --package project-362-audio --test dedup_benchmark -- --nocapture
//! ```
//!
//! ## Metrics
//!
