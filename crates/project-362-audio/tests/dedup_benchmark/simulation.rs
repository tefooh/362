...
/// Chunk duration in seconds (matches project_362 default)
pub const CHUNK_DURATION_SECS: f64 = 10.0;

/// Overlap between chunks in seconds (matches project_362 default)
...
impl RecordingSession {
    ...
    /// Generate simulated audio chunks as they would be produced by project_362
...
use project_362_audio::transcription::text_utils::longest_common_word_substring;
