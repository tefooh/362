...
//!
//! End-to-end benchmarks for the project_362 audio pipeline, measuring:
...
//! cargo test -p project-362-audio --test audio_pipeline_benchmark vad_threshold_sweep_synthetic -- --nocapture
//!
//! # Full benchmark suite (requires dataset)
//! AUDIO_BENCHMARK_DATASET=./scripts/generate-audio-dataset/output \
//!   cargo test --release -p project-362-audio --test audio_pipeline_benchmark -- --nocapture --ignored
//! ```
...
#[allow(dead_code)]
pub async fn new_test_vad() -> project_362_audio::vad::silero::SileroVad {
    project_362_audio::vad::silero::SileroVad::ensure_model_available()
        .await
        .expect("silero model prefetch failed");
    project_362_audio::vad::silero::SileroVad::new()
        .await
