...
//! The actual UI-scanning detection logic lives in `project-362-engine::meeting_watcher::ui_scan`.
...
/// now lives in project-362-engine).
...
async fn replay_scenario(
    ...
    // Track meeting state based on events (simulating what project-362-engine does)
