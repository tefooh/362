...
impl DeepgramTranscriptionConfig {
    ...
    pub fn project_362_cloud(token: String) -> Self {
        Self {
            endpoint: "https://api.project-362.com/v1/listen".to_string(),
            auth_token: token,
    ...
    /// Distinguishes Project362 Cloud proxy from personal Deepgram; safe for logs.
