...
/// See project-362-CLI-RC ("audio chunk DB insert failed after 3 retries, data
...
mod tests {
    ...
    // ── pending-chunk durable recovery (project-362-CLI-RC) ──────────────────
    ...
    fn extract_device_output() {
        let (name, is_input) = extract_device_from_path(
            "/Users/user/.project-362/data/Display 3 (output)_2026-02-27_23-15-38.mp4",
        );
    ...
    fn extract_device_input() {
        let (name, is_input) = extract_device_from_path(
            "/Users/user/.project-362/data/input (input)_2026-02-27_23-15-38.mp4",
        );
