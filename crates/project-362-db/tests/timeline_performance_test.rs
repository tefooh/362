...
mod timeline_performance_tests {
    ...
    use project_362_db::{AudioDevice, DatabaseManager, DeviceType, OcrEngine};
    use std::sync::Arc;
    ...
    async fn insert_frames_with_ocr(
        ...
        for i in 0..count {
            ...
            let ocr_text = format!(
                "Frame {} - Application: VSCode - Window: main.rs - project_362 - \
                 ...
                 Finder - Documents/projects/project-362 - 42 items, 1.2 GB available \
                 ...
                 Terminal output: Compiling project_362 v0.2.76 warning: unused variable \
                 Browser tabs: GitHub - project-362/project-362 - Stack Overflow - rust async \
    ...
    async fn test_file_based_db_performance() {
        let db_path = "/tmp/project_362_test_perf.db";
    ...
    /// Run with: cargo test -p project-362-db --test timeline_performance_test test_stress -- --nocapture --ignored
    #[tokio::test]
