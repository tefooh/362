...
// Run: cargo bench --bench search_accuracy -p project-362-db
//
...
const DB_PATH: &str = "~/.project-362/db.sqlite";
...
fn bench_search_accuracy(c: &mut Criterion) {
    ...
    let pool = rt.block_on(async {
        SqlitePoolOptions::new()
            ...
            .await
            .expect("Failed to connect to database. Make sure project_362 has been run.")
    });
