...
(`project-362-redact::adapters::rfdetr_mlx`) looks for the file at
`~/.project-362/models/rfdetr_v9.safetensors` by default.

Until a safetensors sibling is published next to `rfdetr_v9.onnx` on
[huggingface.co/project-362/pii-image-redactor][hf], convert from the
existing ONNX yourself with the script kept in the archived
[`project-362/rfdetr-mlx`][archive] repo (`convert/onnx_to_mlx.py`).
...
[hf]: https://huggingface.co/project-362/pii-image-redactor
[archive]: https://github.com/project-362/rfdetr-mlx
