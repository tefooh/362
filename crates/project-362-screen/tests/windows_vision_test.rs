...
mod tests {
    use chrono::Utc;
    use project_362_screen::capture_screenshot_by_window::{CapturedWindow, WindowFilters};
    ...
    // crate actually exposes them (see project-362-screen/src/lib.rs which
    // re-exports `RealtimeVisionEvent` from `core` but not the helpers).
    use project_362_screen::core::{continuous_capture, process_ocr_task, RawCaptureResult};
    use project_362_screen::monitor::get_default_monitor;
    use project_362_screen::ocr_cache::WindowOcrCache;
    use project_362_screen::{OcrEngine, PipelineMetrics};
    use std::sync::Arc;
