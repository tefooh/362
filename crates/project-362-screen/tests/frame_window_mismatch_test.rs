...
//!
//! Run with: cargo test -p project-362-screen --test frame_window_mismatch_test -- --nocapture
    ...
    let capture1 = CaptureResult {
        ...
        windows: vec![
            ...
            WindowResult {
                ...
                window_name: "GitHub - project_362".to_string(),
                ocr_text: "project_362 repository README".to_string(),
            },
        ],
    };
