...
/// - project-362-CLI-1Z: "Failed to capture image for window TheBoringNotch"
/// - project-362-CLI-1Y: "Failed to capture image for window Grammarly Desktop"
/// - project-362-CLI-2: "GetFileVersionInfoSizeW failed: WIN32_ERROR(1813)"
///
