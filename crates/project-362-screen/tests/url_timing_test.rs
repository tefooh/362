...
//!
//! Run with: cargo test -p project-362-screen --test url_timing_test -- --nocapture

use project_362_screen::browser_utils::{strip_title_badge, titles_match};
    ...
    fn new() -> Self {
        Self {
            tabs: vec![
                ...
                ("GitHub - project_362", "https://github.com/project-362"),
...
async fn test_title_mismatch_rejects_cross_domain() {
    // Real cases from project_362 data where URL was wrong
