...
//!
//! Run with: cargo test -p project-362-screen --test empty_window_name_test -- --nocapture
...
fn test_production_scenario_multiple_apps() {
    ...
    let windows = vec![
        ...
        ("Arc", "GitHub - project_362"),   // Arc tab
        ("WezTerm", ""),                  // Terminal internal? (empty)
        ("WezTerm", "~/code/project-362"), // Terminal window
