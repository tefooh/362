...
//!
//! Writes individual JPEG files to `~/.project-362/data/YYYY-MM-DD/`
...
impl SnapshotWriter {
    ...
    ///
    /// - `base_dir`: root data directory (e.g., `~/.project-362/data`)
    ...
    pub fn write(
        ...
        let _dip = project_362_core::thread_priority::BackgroundWorkDip::new();
