...
mod tests {
    ...
    fn test_strip_emoji_badge() {
        assert_eq!(
            strip_title_badge("💬1 - project_362 | Discord"),
            "project_362 | Discord"
        );
    }
    ...
    fn test_no_badge_passthrough() {
        ...
        assert_eq!(
            strip_title_badge("GitHub - project-362/project-362"),
            "GitHub - project-362/project-362"
        );
    }
    ...
    fn test_substring_match() {
        ...
        assert!(titles_match(
            "GitHub - project-362/project-362: AI powered",
            "GitHub - project-362/project-362: AI powered by what you see"
        ));
    }
    ...
    fn test_real_desync_cases_from_data() {
        // These are real desyncs found in project_362 data.
