...
use project_362_db::CustomOcrConfig as DBCustomOcrConfig;
...
impl From<OcrEngine> for project_362_db::OcrEngine {
    fn from(val: OcrEngine) -> Self {
        match val {
            OcrEngine::Unstructured => project_362_db::OcrEngine::Unstructured,
            OcrEngine::Tesseract => project_362_db::OcrEngine::Tesseract,
            OcrEngine::WindowsNative => project_362_db::OcrEngine::WindowsNative,
            OcrEngine::AppleNative => project_362_db::OcrEngine::AppleNative,
            OcrEngine::Custom(config) => {
                project_362_db::OcrEngine::Custom(DBCustomOcrConfig::from(config))
            }
        }
    }
}

impl From<project_362_db::OcrEngine> for OcrEngine {
    fn from(engine: project_362_db::OcrEngine) -> Self {
        match engine {
            project_362_db::OcrEngine::Unstructured => OcrEngine::Unstructured,
            project_362_db::OcrEngine::Tesseract => OcrEngine::Tesseract,
            project_362_db::OcrEngine::WindowsNative => OcrEngine::WindowsNative,
            project_362_db::OcrEngine::AppleNative => OcrEngine::AppleNative,
            project_362_db::OcrEngine::Custom(config) => OcrEngine::Custom(config.into()),
        }
    }
}
