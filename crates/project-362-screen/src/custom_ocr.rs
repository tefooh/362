...
impl From<project_362_db::CustomOcrConfig> for CustomOcrConfig {
    fn from(config: project_362_db::CustomOcrConfig) -> Self {
        CustomOcrConfig {
...
impl From<CustomOcrConfig> for project_362_db::CustomOcrConfig {
    fn from(config: CustomOcrConfig) -> Self {
        project_362_db::CustomOcrConfig {
            api_url: config.api_url,
            api_key: config.api_key,
            timeout_ms: config.timeout_ms,
        }
