...
/// Encrypt all files in the project_362 data directory.
///
...
pub async fn encrypt_data_dir(
    ...
    let journal_path = project_362_dir.join(".vault_journal");
...
/// Decrypt all files in the project_362 data directory.
