...
# transcripts) into crates/project-362-audio-eval/evals/fixtures/librispeech/.
...
#
# Once unpacked, run:
#   cargo run --release -p project-362-audio-eval --bin project-362-eval-transcription -- \
...
echo "  cargo run --release -p project-362-audio-eval --bin project-362-eval-transcription -- \\"
