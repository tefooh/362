...
- **Falls back gracefully** — no Obsidian? Saves to `~/.project-362/ai-prompts/` as plain markdown
...
1. Install this pipe from the project-362 store
...
4. Check your journal at `{vault}/project-362/ai-prompts/YYYY-MM-DD.md`

## How it works

The pipe uses project-362's accessibility tree and OCR data to read what's on your screen. It:
...
- Only reads screen data already captured by project-362
- Prompts are saved to your local filesystem only
- You control the output location (Obsidian vault or ~/.project-362/)
