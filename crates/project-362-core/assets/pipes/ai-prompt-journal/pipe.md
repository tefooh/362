...
- If Obsidian is connected: use `{vault_path}/project-362/ai-prompts/`
- If Obsidian is NOT connected: use `~/.project-362/ai-prompts/` as fallback (works for everyone)
