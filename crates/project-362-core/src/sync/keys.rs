...
const DATA_KEY_DOMAIN: &[u8] = b"project-362-sync-data-key-v1";
const SEARCH_KEY_DOMAIN: &[u8] = b"project-362-sync-search-key-v1";
const AUTO_SYNC_PASSWORD_DOMAIN: &str = "project-362-cloud-sync-v1";
...
/// "project-362-cloud-sync-v1")`) so devices signed into the same account can
