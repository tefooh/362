...
//! Cloud sync module for Project362.
//!
...
//!
//! ```rust,ignore
//! use project_362_core::sync::{NewUserKeyData, SyncKeys};
//!
...
//!
//! ```rust,ignore
//! use project_362_core::sync::{ExistingUserKeyData, SyncKeys};
//!
...
//!
//! ```rust,ignore
//! use project_362_core::sync::{encrypt_blob, BlobType};
//!
//! // Encrypt OCR text
...
//!
//! ```rust,ignore
//! use project_362_core::sync::decrypt_blob;
//!
