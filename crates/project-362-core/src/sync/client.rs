...
//! Project362 cloud sync API.

use std::collections::BTreeMap;
use std::time::Duration;

use reqwest::{Client, StatusCode};
use project_362_sync::destination::HttpPutDirect;
use project_362_sync::{BlobDestination, PutRequest, SyncError as TransportError};
...
const DEFAULT_API_URL: &str = "https://project362.com/api/sync";
...
/// Map a `project_362_sync::SyncError` to this crate's `SyncError`,
