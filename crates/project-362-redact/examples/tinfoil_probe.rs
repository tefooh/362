...
//
// Run:
//   cargo run --example tinfoil_probe -p project-362-redact

use project_362_redact::{adapters::tinfoil::TinfoilRedactor, Redactor};
...
async fn main() {
    ...
    let payloads = [
        ...
        "Marcus Chen pushed the prod creds to the project-362/widget repo on slack.".to_string(),
        realistic_long,
    ];
