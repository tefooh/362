...
//!    Always present.
//! 2. [`tinfoil`] — HTTP client for the project-362-hosted Tinfoil
...
//!    fine-tuned `project-362-pii-redactor` text model. CoreML on Mac,
//!    DirectML on Windows.
//!
...
//!    the [project-362-pii-bench-image](https://github.com/project-362/project-362-pii-bench-image)
