...
//! Based on bigbrother's event format with extensions for project_362 integration.
...
impl UiEvent {
    ...
    pub fn to_db_insert(&self, session_id: Option<String>) -> project_362_db::InsertUiEvent {
        use project_362_db::{InsertUiEvent, UiEventType};
