...
//! project-362-a11y: Cross-platform UI event capture for project_362
//!
//! This crate provides keyboard, mouse, and accessibility-based UI event capture
//! as a third modality for project_362, complementing vision (OCR) and audio.
//!
//! ## Features
//!
...
//!
//! ```rust,no_run
//! use project_362_a11y::{UiRecorder, UiCaptureConfig};
//!
