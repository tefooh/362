...
// Tauri app (tao's event loop), but NOT for the headless `project_362` CLI
...
mod tests {
    ...
    fn test_get_clipboard_set_and_read() {
        ...
        let test_text = "project_362_clipboard_test_12345";
        {
    ...
    /// verbatim in the focused app's text field after project_362 quit.
    #[test]
