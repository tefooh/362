...
//!
//! ```sh
//! cargo test -p project-362-a11y --test e2e_tree_walker -- --test-threads=1 --nocapture
//! ```
//!
//! **Requirements**:
...
mod e2e {
    ...
    fn create_walker(max_nodes: usize) -> Box<dyn project_362_a11y::tree::TreeWalkerPlatform> {
    ...
    fn test_textedit_type_and_capture() {
        ...
        let test_text = "project_362 accessibility test 12345";
        ...
        if let TreeWalkResult::Found(snap) = walk_result {
            ...
            if snap.app_name == "TextEdit" {
                assert!(
                    snap.text_content.contains("project_362 accessibility test"),
