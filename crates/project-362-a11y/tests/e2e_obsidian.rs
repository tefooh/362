...
//!
//! See https://github.com/project-362/project-362/issues/3002 — captured frames
...
//!
//! ```sh
//! cargo test -p project-362-a11y --test e2e_obsidian -- --test-threads=1 --nocapture --ignored
//! ```
//!
...
mod obsidian {
    ...
    fn walker() -> Box<dyn project_362_a11y::tree::TreeWalkerPlatform> {
    ...
    fn measure(walker: &dyn project_362_a11y::tree::TreeWalkerPlatform) -> (usize, usize) {
