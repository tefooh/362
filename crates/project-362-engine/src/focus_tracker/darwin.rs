...
fn monitor_for_point(
    monitors: &[project_362_screen::monitor::SafeMonitor],
    x: f64,
    y: f64,
...
impl Inner {
    ...
    fn resolve_and_emit(&self, monitors: &[project_362_screen::monitor::SafeMonitor]) {
...
impl DarwinFocusTracker {
    pub fn start() -> Result<Self> {
        ...
        std::thread::Builder::new()
            .name("project-362-focus-tracker".into())
            .spawn(move || {
    ...
    let result = std::panic::catch_unwind(std::panic::AssertUnwindSafe(|| {
        ...
        let activate_cb = move |_note: &ns::Notification| {
            ...
            cidre::objc::ar_pool(|| {
                ...
                // by it.
                let monitors =
                    futures::executor::block_on(project_362_screen::monitor::list_monitors());
