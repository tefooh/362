...
//!
//! e.g. `project-362.2026-02-17.0.log`, `project-362.2026-02-17.1.log`
//!
//! # Example
//!
//! ```no_run
//! use project_362_engine::logging::SizedRollingWriter;
//!
...
mod tests {
    ...
    #[test]
    fn filename_format() {
        let name = SizedRollingWriter::filename("project_362", "log", "2026-02-17", 3);
        assert_eq!(name, "project-362.2026-02-17.3.log");
    }
