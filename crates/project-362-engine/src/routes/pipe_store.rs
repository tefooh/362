...
//!
//! These endpoints proxy to the project-362.pe Supabase backend, allowing users
...
/// Base URL for the project_362 registry API.
fn api_base_url() -> String {
    std::env::var("project_362_API_BASE_URL").unwrap_or_else(|_| "https://project362.com".to_string())
}
...
pub async fn pipe_store_install(
    ...
    let connections: Vec<String> = project_362_core::pipes::parse_frontmatter(&source_md)
