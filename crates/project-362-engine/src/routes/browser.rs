...
//! [`project_362_connect::connections::browser`]; this file is a thin shell
...
use project_362_connect::connections::browser::{
...
pub use project_362_connect::connections::browser::BrowserBridge;
...
async fn handle_extension_socket(socket: WebSocket, bridge: Arc<InnerBridge>) {
    ...
    let ping_task = tokio::spawn(async move {
        ...
        loop {
            ...
            // require leaking axum types into project-362-connect.
            if ping_transport
