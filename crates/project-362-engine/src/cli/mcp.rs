    ...
    match command {
        McpCommand::Setup {
            ...
            let run_command = format!(
                "uv --directory {} run project-362-mcp --port {}",
            ...
            if should_download {
                ...
                let owner = "project_362";
                let repo = "project_362";
                let branch = "main";
                let target_dir = "packages/project-362-mcp";
...
async fn download_mcp_directory(
    ...
    headers.insert(USER_AGENT, HeaderValue::from_static("project-362-cli"));
        ...
        match item.content_type.as_str() {
            ...
            "dir" => {
                ...
                let subdir_api_url = format!(
                    "https://api.github.com/repos/{}/{}/contents/{}?ref={}",
                    "project_362", "project_362", item.path, "main"
                );
