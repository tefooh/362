...
//! `project-362-events` bus when the OS permission state changes.
//!
//! ## Design
//!
...
use project_362_core::permissions::{check_permissions, PermissionStatus};
...
fn keychain_accessible() -> bool {
    use project_362_secrets::keychain::{get_key, is_keychain_available, KeyResult};
    ...
    if !project_362_secrets::is_encryption_requested(
