...
//!
//! Used by the CLI binary to persist settings in `~/.project-362/config.toml`.
...
/// Default config file path: `~/.project-362/config.toml`.
...
/// Resolve the project_362 config directory: `~/.project-362/`
fn dirs_next() -> Option<PathBuf> {
    dirs::home_dir().map(|h| h.join(".project-362"))
}
