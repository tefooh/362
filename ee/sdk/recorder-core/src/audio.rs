...
//! Microphone level meter. We deliberately don't pull `project-362-audio` —
...
fn build_and_run_stream(level_bits: &'static AtomicU32) -> Result<cpal::Stream> {
    ...
    let err_fn = |e| tracing::warn!("project-362-sdk mic stream err: {e}");
