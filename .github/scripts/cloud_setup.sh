...
# build + unit-test the project-362 Rust workspace and TS bindings.
#
...
#
# Verify with:  cargo test --workspace --exclude project-362-rfdetr-mlx
# (project-362-rfdetr-mlx is Apple-MLX-only and cannot build on Linux.)
set -euo pipefail

echo "::: project-362 headless setup — installing build dependencies :::"
...
cargo fetch
cargo build --workspace --exclude project-362-rfdetr-mlx || true

echo "::: setup complete — verify: cargo test --workspace --exclude project-362-rfdetr-mlx :::"
